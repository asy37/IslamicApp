...
type DhikrBottomBarProps = {
  readonly currentDhikr: DhikrOption;
  readonly dhikrOptions: readonly DhikrOption[];
  ...
  return (
    <View className="absolute bottom-8 left-0 right-0 px-6 z-20 flex justify-center">
      ...
      >
        ...
        {/* Stats Button */}
        <Pressable className="flex-col items-center justify-center w-14 h-14 rounded-xl">
          <MaterialIcons
            name="bar-chart"
            size={24}
            color={isDark ? "#8FA6A0" : "#6B7F78"}
