...
import QiblaHeader from "@/features/qibla/components/QiblaHeader";
import Compass from "@/features/qibla/components/Compass";
import AlignmentFeedback from "@/features/qibla/components/AlignmentFeedback";
...
export const QiblaView = () => {
    const BAD_ACCURACY_THRESHOLD = 1;
