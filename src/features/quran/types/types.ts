...
// --------------------
export interface Ayah extends AyahApi {
...
// Surah - UI Format
// --------------------
export interface Surah extends Omit<SurahApi, "ayahs" | "revelationType" | "englishNameTranslation"> {
...
export type AyahBlockProps = Readonly<{
  ayah: Ayah;
...
export type PageIndicatorProps = Readonly<{
  goPrev: () => void;
  goNext: () => void;
  numberOfSurah: number;
}>;

export type QuranContentProps = Readonly<{
  ayahs: Ayah[];
  goNext: () => void;
  goPrev: () => void;
...
export type QuranSubHeaderProps = Readonly<{
